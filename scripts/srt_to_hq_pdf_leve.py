...
# Busca legenda SRT, se não encontrar, busca SRV3
...
if os.path.exists(srt_file):
    ...
    raise FileNotFoundError(f'Nenhum arquivo de legenda SRT ou SRV3 encontrado para {base_path}')
...
# Grid defaults (used when running this script directly)
colunas = 2
linhas = 3
...
# Note: the script can also be used by importing and calling `gerar_pdf_leve_grid()`.
